---
layout: page
title: gstreamer1.0-plugins-good-doc - Binary Package
description: >
  gstreamer1.0-plugins-good-doc - Binary Package
date: 2018-02-19 18:45:26 +0800
source_url: '/read/subject/package/binary-package/gstreamer1.0-plugins-good-doc/index.md'
parent:
...
執行下面指令，可以觀看「Binary Package: [gstreamer1.0-plugins-good-doc](https://packages.ubuntu.com/artful/gstreamer1.0-plugins-good-doc)」相關資訊

``` sh
$ apt-cache show gstreamer1.0-plugins-good-doc
```
...
Filename: pool/main/g/gst-plugins-good1.0/gstreamer1.0-plugins-good-doc_1.12.3-1ubuntu1_all.deb
Size: 231712
MD5sum: c193b0b595daf01e02f9333fa2766cc4
SHA1: 4a1cca3f362d1f1c9f45f5ca83bb2ce9cf9f45c0
SHA256: 280cfebe80011a8f44ef79fef34a35701240a9e55bacd17bdf1faf8cd09b15be
...
執行下面指令，安裝「[gstreamer1.0-plugins-good-doc](https://packages.ubuntu.com/artful/gstreamer1.0-plugins-good-doc)」這個套件。

``` sh
$ sudo apt-get install gstreamer1.0-plugins-good-doc
```

## 檔案

執行下面指令，觀看「[gstreamer1.0-plugins-good-doc](https://packages.ubuntu.com/artful/gstreamer1.0-plugins-good-doc)」這個套件，安裝那些檔案在系統上。

``` sh
$ dpkg -L gstreamer1.0-plugins-good-doc | sort
```
...
/usr/share
/usr/share/doc
/usr/share/doc/gstreamer1.0-plugins-good-doc
/usr/share/doc/gstreamer1.0-plugins-good-doc/AUTHORS
/usr/share/doc/gstreamer1.0-plugins-good-doc/changelog.Debian.gz
/usr/share/doc/gstreamer1.0-plugins-good-doc/copyright
/usr/share/doc/gstreamer1.0-plugins-good-doc/NEWS.gz
/usr/share/doc/gstreamer1.0-plugins-good-doc/README.Debian
/usr/share/doc/gstreamer1.0-plugins-good-doc/README.gz
/usr/share/gtk-doc
...
執行下面指令，可以了解到「[gstreamer1.0-plugins-good-doc](https://packages.ubuntu.com/artful/gstreamer1.0-plugins-good-doc)」這個套件，是來自於哪個「Source Package」

``` sh
$ apt-cache showsrc gstreamer1.0-plugins-good-doc | grep '^Package:'
```
...
```
表示「Binary Package: [gstreamer1.0-plugins-good-doc](https://packages.ubuntu.com/artful/gstreamer1.0-plugins-good-doc)」是來自於「Source Package: [gst-plugins-good1.0](https://packages.ubuntu.com/source/artful/gst-plugins-good1.0) ([explore](/book-framework-gstreamer/read/subject/package/source-package/gst-plugins-good1.0))」

或是執行下面指令

``` sh
$ apt-cache show gstreamer1.0-plugins-good-doc | grep '^Source:'
```
